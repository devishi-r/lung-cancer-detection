...
def main():
    ...
    print("Entering if statement of main function in visualisation.py")
    # import os
    print(os.path.isdir("D:/Lung PET data/manifest-1608669183333/Annotation/A001/"))


    print("Annotation path is a directory: ",os.path.isdir(args.annotation_path))
    # import os
    print("CWD:", os.getcwd())
    print("Exists:", os.path.exists(args.annotation_path))
    print("IsDir:", os.path.isdir(args.annotation_path))
